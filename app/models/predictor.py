...
from app.models.model_loader import (load_interpreter,
                                     load_label_encoder_gender,
                                     load_one_hot_encoder_geo, load_scaler)
...
def preprocess_input(data):
    ...
    geo_encoded_df = pd.DataFrame(
        geo_encoded, columns=on_hot_encoder_geography.get_feature_names_out()
    )
